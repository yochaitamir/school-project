...
class ListsController
{
    ...
    public function studentDetails()
    {
        ...
        foreach ($stu as $requestedStudent) {
            $_SESSION['studentid']=$requestedStudent['ID'];
            $_SESSION['studentname']=$requestedStudent['studentname'];
    ...
    public function affirmingDelete($student)
    {
    ...
    public function editCourse()
    {
        ...
        echo '"><br><br>
                     ...
                     <textarea type=text name=coursedesc>';
        if (isset($_GET['school'])&&$_GET['school']=='editcourse') {
            echo $course['description'];
        }
        echo '</textarea><br>';
        if (isset($_GET['course'])&&$_GET['course']=='addcourse') {
            echo '
    ...
    public function affirmingdeletecourse()
    {
        echo 'are you sure you want to delete course:';
        $_SESSION['courseid'];
        echo '<form method="POST" action="">';
         
        echo '<input type=submit name=deletecourse value="delete">';
        
        echo  '<input type=submit name=deletecancel value="cancel">';
    }
}
